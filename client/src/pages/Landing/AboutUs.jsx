        ...
        <div className='container mx-auto w-auto lg:h-[85vh] bg-pink-50 bg-blend-lighten p-5 flex flex-col gap-4 mt-10 lg:flex-row lg:relative '>
            <Card className='flex flex-col p-8 gap-5 lg:h-fit lg:w-96  lg:absolute lg:top-12 lg:left-24 lg:gap-2 lg:p-7'>
                ...
                <Card className='flex flex-row gap-6 shadow-none items-center'>
                    <Avatar src='./src/assets/images/team/ea-1.png' alt='image' className="h-20 w-20 lg:h-16 lg:w-16"></Avatar>
                    <div className='about'>
                ...
                <Card className='flex flex-row gap-6 shadow-none items-center'>
                    <Avatar src='./src/assets/images/team/ea-2.png' alt='image' className="h-20 w-20 lg:h-16 lg:w-16"></Avatar>
                    <div className='about'>
                ...
                <Card className='flex flex-row gap-6 shadow-none items-center'>
                    <Avatar src='./src/assets/images/team/ea-3.png' alt='image' className="h-20 w-20 lg:h-16 lg:w-16"></Avatar>
                    <div className='about'>
                ...
                <Card className='flex flex-row gap-6 shadow-none items-center'>
                    <Avatar src='./src/assets/images/team/ea-4.png' alt='image' className="h-20 w-20 lg:h-16 lg:w-16"></Avatar>
                    <div className='about'>
            ...
            <Card className="flex flex-col p-8 gap-5 lg:h-fit lg:absolute lg:top-36 lg:left-96">
                <Avatar src='./src/assets/images/team/agent-5.jpg' className='w-auto h-50' variant='rounded'></Avatar>
                <div>
            ...
            <img src='./src/assets/images/about/element-3.png' alt='img' className='w-20 h-20 hidden lg:block lg:absolute lg:top-5 lg:left-[50%] opacity-20'></img>
            <img src='./src/assets/images/about/element-5.png' alt='img' className='w-20 h-6 hidden lg:block lg:absolute lg:top-[80%] lg:left-[20%] opacity-25'></img>
            <img src='./src/assets/images/about/element-3.png' alt='img' className='w-20 h-20 hidden lg:block lg:absolute lg:top-[80%] lg:left-[55%] opacity-20'></img>
            <img src='./src/assets/images/about/element-7.png' alt='img' className='w-16 h-20 hidden lg:block lg:absolute lg:top-[30%] lg:left-4'></img>
        </div>
    )
}
