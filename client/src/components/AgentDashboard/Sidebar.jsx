            ...
            <div className='mt-28'>
                ...
                <Drawer open={open} onClose={closeDrawer} className=" overflow-scroll ">
                    ...
                    <List>
                        ...
                        <Link className={` transition ease-in rounded-lg ${selectedButton === 'Logout' ? 'bg-black  text-white' : 'bg:white text-black'}`} onClick={() => { handleButtonClick('Logout'); handleLogout() }}>
                            <ListItem>
                                <ListItemPrefix>
